...
| Edges | 11,663 | **11,691** | +27 `SAME_AS` (3 ORCID-anchored, then +24 human-reviewed on 2026-07-25), +1 `AUTHORED_BY` (KI-18(a) un-fusion, 2026-07-25) |
| Publication | 805 | 805 | — |
...
> **Note on totals.** Current live state is **4,886 / 11,691** (2026-07-25), and `CLAUDE.md`,
